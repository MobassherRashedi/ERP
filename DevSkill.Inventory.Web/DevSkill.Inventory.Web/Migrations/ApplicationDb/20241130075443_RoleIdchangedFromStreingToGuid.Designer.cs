...
namespace DevSkill.Inventory.Web.Migrations.ApplicationDb
{
    ...
    [Migration("20241130075443_RoleIdchangedFromStreingToGuid")]
    partial class RoleIdchangedFromStreingToGuid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevSkill.Inventory.Infrastructure.Identity.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevSkill.Inventory.Infrastructure.Identity.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevSkill.Inventory.Infrastructure.Identity.UserProfile", b =>
                {
                    b.HasOne("DevSkill.Inventory.Infrastructure.Identity.ApplicationUser", "ApplicationUser")
                        .WithOne()
                        .HasForeignKey("DevSkill.Inventory.Infrastructure.Identity.UserProfile", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
