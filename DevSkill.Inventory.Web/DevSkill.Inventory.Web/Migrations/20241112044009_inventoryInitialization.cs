...
{
    /// <inheritdoc />
    public partial class inventoryInitialization : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Crafts_Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Food_Ingredients = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StorageInstructions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrganicCertification = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Furniture_Material = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Dimensions_Length = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ...
                    Dimensions_MeasurementUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Grocery_ExpiryDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Grocery_StorageInstructions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Grocery_OrganicCertification = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrescriptionRequired = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Healthcare_ExpiryDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Healthcare_Brand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    HomeAppliances_WarrantyPeriod = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HomeAppliances_Brand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Jewelry_Material = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GemstoneType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Weight = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Jewelry_Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Jewelry_Brand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficeSupplies_Brand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficeSupplies_Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficeSupplies_Model = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PetSupplies_Material = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AgeGroup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PetSupplies_Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PropertyType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    SizeInSquareFeet = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Bedrooms = table.Column<int>(type: "int", nullable: true),
                    Bathrooms = table.Column<int>(type: "int", nullable: true),
                    PropertyCondition = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ListingAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Toys_AgeGroup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Toys_Material = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BatteryRequired = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Categories_MeasurementUnits_Dimensions_MeasurementUnitId",
                        column: x => x.Dimensions_MeasurementUnitId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockTransferProducts", x => new { x.ProductId, x.StockTransferId });
                    table.ForeignKey(
                        name: "FK_StockTransferProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_StockTransferProducts_StockTransfers_StockTransferId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_Dimensions_MeasurementUnitId",
                table: "Categories",
                column: "Dimensions_MeasurementUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransferProducts_StockTransferId",
                table: "StockTransferProducts",
